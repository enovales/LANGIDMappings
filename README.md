...
This project contains utilities for mapping Windows LANGID values to other formats. You can either include this library via Nuget, or simply include the LangIDMappings.fs file in your project (via paket or otherwise).
...
GitHub Actions |
:---: |
[![GitHub Actions](https://github.com/enovales/LANGIDMappings/workflows/Build%20master/badge.svg)](https://github.com/enovales/LANGIDMappings/actions?query=branch%3Amaster) |
[![Build History](https://buildstats.info/github/chart/enovales/LANGIDMappings)](https://github.com/enovales/LANGIDMappings/actions?query=branch%3Amaster) |

## NuGet 

Package | Stable | Prerelease
--- | --- | ---
LANGIDMappings | [![NuGet Badge](https://buildstats.info/nuget/LANGIDMappings)](https://www.nuget.org/packages/LANGIDMappings/) | [![NuGet Badge](https://buildstats.info/nuget/LANGIDMappings?includePreReleases=true)](https://www.nuget.org/packages/LANGIDMappings/)
