...
let productName = "LANGIDMappings"
let sln = "LANGIDMappings.sln"
...
let gitRepoName = "LANGIDMappings"
...
// Coverage is very skewed for this library, so ignore it.
    ...
    |> Seq.iter(fun proj ->
        let args  =
            [
                ...
                FSharpAnalyzers.Ignore_Files [ "*.fsi" ]
            ]
